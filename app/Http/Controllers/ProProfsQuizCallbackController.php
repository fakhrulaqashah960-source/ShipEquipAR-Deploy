...
class ProProfsQuizCallbackController extends Controller
{
    ...
    {
        /*
         * ProProfs supports both JSON and REQUEST/Query String.
         * We accept either format so the Laravel endpoint is flexible.
         */
        ...
        /*
         * Never accept callbacks unless the shared
        ...
        /*
         * Link the ProProfs submission back to the
         * logged-in ShipEquipAR user.
         *
         * First choice: Laravel user ID passed to ProProfs.
         * Fallback: matching email address.
         */
        $user = null;
        ...
        $attemptedAt =
            $this->parseAttemptDate(
                $payload['attempt_date'] ?? null
            );
